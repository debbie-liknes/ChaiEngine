/**
 * @file MatBase.h
 * @brief A simple matrix class template with basic operations.
 */
#pragma once
#include <VecBase.h>
#include <cassert>
...
{
    /**
     * @brief A simple matrix class template.
     */
    ...
    public:
        ...
        /**
         * @brief A proxy class for a matrix row, allowing convenient access and assignment.
         */
        class RowProxy
        {
        public:
        ...
        /**
         * @brief A proxy class for a const matrix row, allowing convenient access and conversion to
         * Vec
         */
        class ConstRowProxy
        {
        ...
        /**
         * @brief Constructs a matrix with all elements initialized to the same value.
         */
        ...
        /**
         * @brief Constructs a matrix from an initializer list. If the list contains a single
         * element equal to 1, the matrix is initialized to the identity matrix. Otherwise, the list
         * must contain exactly R*C elements to fill the matrix in row-major order
         */
        ...
        /**
         * @brief Constructs a matrix from an initializer list of a different arithmetic type
         */
        template <class U,
        ...
        /**
         * @brief Constructs a matrix from a variadic list of scalar or vector arguments.
         */
        template <class... Args,
        ...
        /**
         * @brief Convenience function to create a zero matrix
         */
        ...
        /**
         * @brief Convenience function to create an identity matrix
         ...
         * For square matrices, this is also the inverse
