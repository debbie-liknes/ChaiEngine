...
namespace chai::math
{
    ...
    template <typename T>
    bool nearlyEqual(T a, T b, T eps = chai::math::kEpsilonF)
    {
        return std::fabs(a - b) < eps;
    }

    template <typename T>
    ::testing::AssertionResult QuatNear(const chai::math::Quaternion<T>& a,
                                        const chai::math::Quaternion<T>& b,
                                        T eps = chai::math::kEpsilonF)
    {
