...
TEST(aabb, expand)
{
    auto aabb1 = chai::aabb{
        .center = chai::math::Vec3(0, 0, 0),
        .width = 1,
        .length = 1,
        .height = 1
    };
    auto aabb2 = chai::aabb{.center = chai::math::Vec3(0, 0, 0),
        .width = 1,
        .length = 1,
        .height = 1
    };
    ...
    auto aabb3 = chai::aabb{.center = chai::math::Vec3(0, 0, 0),
        .width = 2,
        .length = 2,
        .height = 2
    };
    ...
    auto aabb4 = chai::aabb{.center = chai::math::Vec3(1, 1, 1),
        .width = 1,
        .length = 1,
        .height = 1
    };
    auto aabb5 = chai::aabb{
        .center = chai::math::Vec3(0.5f, 0.5f, 0.5f),
        .width = 2,
        .length = 2,
        .height = 2
    };
    ...
    chai::BoxCollider box{
        .box{
            ...
            .height{1}
                          ...
                          .center{chai::math::Vec3(0, 0, 0)},
                          .rot{chai::math::Quat(1, 0, 0, 0)}
    };
    dbvh.insert(&box);

    auto aabb = box.getWorldBounds();
    EXPECT_EQ(aabb.center, chai::math::Vec3(0, 0, 0));
