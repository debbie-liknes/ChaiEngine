...
namespace chai
{
    ...
    public:
        ...
        void setHoveredCamera(uint64_t cameraId) override;
        uint64_t getHoveredCamera() const override;
        uint64_t getActiveCamera() const override;
    ...
    private:
        ...
        uint64_t hoveredCamera_ = 0;
        uint64_t capturedCamera_ = 0;
