...
//    }
//
//    Handle<MaterialAsset> createMaterial(const tinygltf::Material& mat,
//                               const tinygltf::Model& gltf,
//                               const std::vector<Handle<TextureResource>>& textures)
//    {
...
//        //}
//
//        //return AssetManager::instance().add<MaterialAsset>(std::move(matAsset));
//        return Handle<MaterialAsset>{};
//    }
//
...
//
//                //Handle<MaterialAsset> materialHandle = primitive.material >= 0
