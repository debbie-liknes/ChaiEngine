...
//
//        Handle<ShaderAsset> getGBufferShader() { return m_gbufferShader; }
//        Handle<ShaderAsset> getLightingShader() { return m_lightingShader; }
//
//        static Handle<MaterialResource> createFromAsset(Handle<MaterialAsset> assetHandle)
//        {
...
//        }
//
//        static Handle<MaterialResource> createFromAsset(const MaterialAsset* asset)
//        {
//            //if (!asset)
//            //    return Handle<MaterialResource>{};
//
...
//
//        //    m_gbufferShader = AssetManager::instance().add(std::move(shaderAsset));
//        //}
//
...
//
//        //    m_lightingShader = AssetManager::instance().add(std::move(shaderAsset));
//        //}
//
...
//
//        //    m_skyboxShader = AssetManager::instance().add(std::move(shaderAsset));
//        //}
//
//        class Builder
//        {
//        public:
//            explicit Builder(Handle<ShaderAsset> shaderHandle) : m_shaderHandle(shaderHandle)
//            {
...
//            }
//
//            Builder& setTexture(const std::string& name, Handle<MaterialResource> texHandle)
//            {
//                return set(name, texHandle);
//            }
//
//            Handle<MaterialResource> build()
//            {
//                //auto resource = std::make_unique<MaterialResource>();
...
//                //        //resource->textures[name] = {std::get<Handle<MaterialResource>>(value),
//                //        //                            nextTextureSlot++};
//                //    } 
//                //    else {
...
//
//        Handle<ShaderAsset> getPhongShader() { return m_phongShader; }
//
//        Handle<ShaderAsset> getPBRShader() { return m_pbrShader; }
//
//        Handle<MaterialAsset> getPhongMaterial() { return m_phongMaterial; }
//
//        Handle<MaterialResource> getPBRMaterial() { return m_pbrMaterial; }
//
//        Handle<ShaderAsset> getSkyboxShader() { return m_skyboxShader; }
//
//    private:
//        MaterialSystem();
//
...
//
//        //    m_phongShader = AssetManager::instance().add(std::move(shaderAsset));
//        //}
//
//        //void loadPBRDefault()
//        //{
...
//        //    //shaderAsset->addUniform("u_metallicRoughnessMap", DataType::Sampler2D, false);
//
//        //    m_pbrShader = AssetManager::instance().add(std::move(shaderAsset));
//
...
//        //}
//
//        Handle<ShaderAsset> m_phongShader;
//        Handle<ShaderAsset> m_pbrShader;
//        Handle<MaterialResource> m_pbrMaterial;
//        Handle<MaterialAsset> m_phongMaterial;
//        Handle<ShaderAsset> m_gbufferShader;
//        Handle<ShaderAsset> m_lightingShader;
//        Handle<ShaderAsset> m_skyboxShader;
//    };
//} // namespace chai